...
```bash
npx harbinger init   # Scaffold project
...
| **event-handler** | `harbinger-ai/harbinger:event-handler-${HARBINGER_VERSION}` | Node.js runtime + PM2, serves the bind-mounted Next.js app on port 80 |
